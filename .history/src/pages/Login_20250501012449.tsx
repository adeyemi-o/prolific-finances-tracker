    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center max-w-4xl w-full">
        ...
        <div className="hidden md:flex justify-center items-center">
          <img 
            src="/placeholder.svg" // Replace with your accounting image in public folder
            alt="Accounting illustration" 
            className="w-64 h-64 object-contain opacity-80" // Adjust size, object-fit, and opacity as needed
          />
        </div>
      </div>
    </div>
