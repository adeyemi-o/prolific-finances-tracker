...
import { getUsers, deleteUser, createUser, ensureUserRoles } from "@/lib/supabase";
  ...
  useEffect(() => {
    const loadUsers = async () => {
      try {
        ...
        // First ensure all users have the correct role in their metadata
        // This synchronizes between database roles and user metadata
        try {
